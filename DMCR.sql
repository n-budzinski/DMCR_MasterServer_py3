...
--
-- Host: localhost    Database: alexander
-- ------------------------------------------------------
...
INSERT INTO `gmids` VALUES (3,'TEST-TEST-TEST-TEST',0);
...
INSERT INTO `punishments` VALUES (1,'2023-07-22 10:50:53',15,1,'This is a punishment'),(2,'2023-07-22 10:50:53',15,2,'This is another punishment');
...
BEGIN
	...
	IF LENGTH(VE_NICK) < 1 THEN
		SIGNAL SQLSTATE '45003' SET MESSAGE_TEXT = "ERR_NICK_LENGTH";
	ELSEIF LENGTH(VE_PASS) < 1 THEN
		SIGNAL SQLSTATE '45005' SET MESSAGE_TEXT = "ERR_PASS_EMPTY";
	-- ELSEIF LENGTH(VE_PASS) < 8 OR LENGTH(VE_PASS) > 24 THEN
	-- 	SIGNAL SQLSTATE '45005' SET MESSAGE_TEXT = "ERR_PASS_LENGTH"; 
	ELSEIF LENGTH(VE_GMID) < 1 THEN
		SIGNAL SQLSTATE '45008' SET MESSAGE_TEXT = "ERR_GMID_EMPTY"; 
	END IF;
...
BEGIN
	IF NOT EXISTS(SELECT email REGEXP '^[a-zA-Z0-9][a-zA-Z0-9._-]*@[a-zA-Z0-9][a-zA-Z0-9._-]*\\.[a-zA-Z]{2,4}$') OR char_length(email) > 128 THEN
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERR_MAIL_FORMAT';
	END IF;
...
-- Dump completed on 2023-08-08 23:03:15
-- MySQL dump 10.13  Distrib 8.0.33, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-05-24 11:19:03',NULL),('diagnostics.include_raw','OFF','2023-05-24 11:19:03',NULL),('ps_thread_trx_info.max_length','65535','2023-05-24 11:19:03',NULL),('statement_performance_analyzer.limit','100','2023-05-24 11:19:03',NULL),('statement_performance_analyzer.view',NULL,'2023-05-24 11:19:03',NULL),('statement_truncate_len','64','2023-05-24 11:19:03',NULL);
...
-- Dump completed on 2023-08-08 23:03:18
